...
namespace WMS
{
    public partial class DeclarePicklistScanningWindow : Form
    {
        public DeclarePicklistScanningWindow()
        {
            InitializeComponent();
        }

        private void DeclarePicklistScanningWindow_Load(object sender, EventArgs e)
        {
