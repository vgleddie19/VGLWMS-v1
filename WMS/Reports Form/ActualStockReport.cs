...
namespace WMS
{
    public partial class ActualStockReport : Form
    {
        ...
        {
            DataTable dt = DataSupport.RunDataSet(@"SELECT Location, Product,Description[desc], l.Uom,Qty, lot_no[Lot], Expiry
            ...
            rviewer = new crtactualstockreport();
            rviewer.SetDataSource(dt);

            viewer.ReportSource = rviewer;
            viewer.RefreshReport();
            btnDeclareExpiredStocks.Text = "Print";
            button1.Text = "Close";
